        ...
        <div class="px-4 py-5 sm:px-6">
            ...
            <h3 class="text-lg leading-6 font-medium text-gray-900">
                <p style="text-indent: 2rem;text-align: justify;">
                    На текущий момент всего собранно данных на {{$count_children}} детей!
                    Мы продолжим работу по сбору данных для реализации поставленных целей!
                </p>
                <p style="text-indent: 2rem;text-align: justify;">
                    Ознакомиться с сводной таблицей можно, указав свой телефонный номер, по ссылке:
                    <a href="/check-parent" class="text-indigo-600">Сводная таблица родителей и детей</a>
                </p>
            </h3>
        </div>
    </div>
