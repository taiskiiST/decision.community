  ...
  useEffect(() => {
    const filteredUsers = users.filter((person) => {
      ...
      return (
        ...
        (person.email &&
          person.email.toLowerCase().includes(searchTermLowerCased)) ||
        (person.position &&
          person.position.toLowerCase().includes(searchTermLowerCased)) ||
        (person.permissions &&
          person.permissions
            .join()
            .toLowerCase()
      ...
      <div className="flex hidden flex-col lg:-mt-px xl:flex">
        <div className="flex">
          ...
          <div className="relative w-80 px-8 py-3">
            {isSuperAdmin && (
              <Listbox value={filterCompany} onChange={setFilterCompany}>
                {({ open }) => (
                  <>
              ...
              <table className="min-w-full divide-y divide-gray-200 ">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th scope="col" className="relative px-6 py-3 text-center">
                      <button className="relative px-6 py-3 text-center">
                        Право
                      </button>
                    </th>
                    <th scope="col" className="relative px-6 py-3 text-center">
                  ...
                  {searchResults.map((user, index) => (
                    ...
                    >
                      <td>
                        ...
                        <div className="whitespace-wrap text-wrap px-6 py-4 text-center text-sm font-bold text-gray-900">
                          {user.rights &&
                            user.rights.map((rights_user, index_rights) => (
                              <div
