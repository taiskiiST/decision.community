        ...
        <div class="relative isolate -z-10 overflow-hidden pt-14">
            <div class="mx-auto max-w-7xl px-6 py-32 sm:py-40 lg:px-8">
                <div class="mx-auto max-w-2xl lg:mx-0 lg:grid lg:max-w-none lg:grid-cols-2 lg:gap-x-16 lg:gap-y-6 xl:grid-cols-1 xl:grid-rows-1 xl:gap-x-8">
                    ...
                    {{-- Form --}}
                    <div class="aspect-[6/5] w-full max-w-lg rounded-2xl object-cover lg:max-w-none xl:row-span-2 xl:row-end-2">
                        <div class="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8">
                            <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
                                <div class="bg-white/20 px-6 py-12 shadow sm:rounded-lg sm:px-12">
                                    <h2 class="uppercase text-xl font-bold tracking-tight text-white text-center">
                                        создать вопрос
                                    </h2>

                                    <form class="space-y-6" action="#">
                                        <div>
                                            <button type="button" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Написать</button>
                                        </div>

                                        <div>
                                            <button type="button" class="flex w-full justify-center rounded-md bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">E-mail</button>
                                        </div>

                                        <div>
                                            <button type="button" class="flex w-full justify-center rounded-md bg-brand-yellow px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-brand-yellow focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-yellow">Создать</button>
                                        </div>
                                    </form>
