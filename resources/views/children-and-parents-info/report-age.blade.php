                            ...
                            @foreach($age_by_group as $group_age)
                                <tr class="@if ($loop->odd) bg-gray-200 @else bg-white @endif">
                                    ...
                                    <td class="px-6 py-4 whitespace-wrap text-sm font-medium text-gray-900 text-center">
                                        <div class="text-xs">{{$group_age['group_age']}}
                                            @if ($group_age['group_age'] == 1) год @endif
                                            @if ($group_age['group_age'] > 1 && $group_age['group_age'] < 5) года @endif
                                            @if ($group_age['group_age'] >= 5 || $group_age['group_age'] == 0) лет @endif
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-wrap text-sm font-medium text-gray-900 text-center">
