...
mix.js('resources/js/app.js', 'public/js')
    ...
    .js('resources/js/react/RatingStarsForReports/App.js', 'public/js/RatingStarsForReports.js')
    ...
    .js('resources/js/react/DisplayQuestionsEditor/index.js', 'public/js/DisplayQuestionsEditor.js')
    .js('resources/js/react/LandingMainPage/index.js', 'public/js/LandingMainPage.js')
    .js('resources/js/react/FormattedTexQuestion/index.js', 'public/js/FormattedTexQuestion.js')
    .js('resources/js/react/FormattedTexQuestionMobile/index.js', 'public/js/FormattedTexQuestionMobile.js')
    .js('resources/js/react/PreviewTextQuestionMobile/index.js', 'public/js/PreviewTextQuestionMobile.js')
    .react()
