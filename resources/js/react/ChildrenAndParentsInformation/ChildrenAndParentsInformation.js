        ...
        <div className="container px-4">
            ...
            >
                ...
                <div className="col-span-6 sm:col-span-3 mt-2 border-t-8 border-double border-gray-400">
                    ...
                    ></input>
                    <div className="inline-flex flex-row w-full">
                        <label htmlFor='parent_phone' className="mt-3 block text-sm font-medium text-gray-700">Укажите контактный номер телефона родителя или родственника или лица их замещающего в формате  <b>8(9XX)XXX-XX-XX</b></label>
