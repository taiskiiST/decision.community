            ...
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <div class="mt-1 relative rounded-md shadow-sm -ml-3">
                        ...
                        <input min="0" step="1" type="number" name="phone" id="phone" class="ml-3 focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-7 pr-12 sm:text-sm border-gray-300 rounded-md" placeholder="9007775511">
                    </div>
                </div>
