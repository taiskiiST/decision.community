          ...
          if (!poll_report_done) {
            return (
              <div key={index} className="whitespace-pre-line">
                <label className="whitespace-wrap text-wrap mt-6 block text-lg font-semibold">
                  <a
                          ...
                          <td>
                            <div
                              className={`whitespace-wrap px-1 py-4 text-center text-sm text-gray-900 ${
                                ...
                                questionMaxCountVotes[question.id]
                                  ? 'font-bold'
                                  : 'font-medium'
                              }`}
                            >
                          ...
                          <td>
                            ...
                            >
                              {countWeightsVotedForAnswer[answer.id]
                                ? countWeightsVotedForAnswer[answer.id].toFixed(
                                    2,
                                  )
                                : 0}
                            </div>
                    ...
                    <tr className="border-b border-gray-400 bg-gray-100 bg-white">
                      ...
                      <td>
                        <div className="whitespace-nowrap bg-gray-200 px-1 py-4 text-center text-sm font-bold">
                          {countWeightsByQuestion[question.id].toFixed(2)} из{' '}
                          {poll.potential_voters_number}
                        </div>
                      </td>
                      <td>
            ...
            return (
              <div className="text-center" key={index}>
                <div className="text-left">
                  <label className="text-wrap mt-6 block text-lg font-semibold">
                    <a
                      href={`/polls/view/question/${question.id}/`}
                      // className="text-indigo-600 hover:text-indigo-900"
                    >
                    ...
                    return (
                      <div className="w-1/9 text-7xl" key={index}>
                        <button
                          ...
                          className={`${
                            index <=
                            middleAnswerThatAllUsersMarkOnReport[question.id]
                              ? 'on'
                              : 'off'
                          } 
                                                    index_${index}
                ...
                <label className="italic">
                  ...
                  <b>{middleAnswerThatAllUsersMarkOnReport[question.id]}</b>
                ...
                <label className="italic">
                  {' '}
                  Проголосовано <b>{countByQuestion[question.id]}</b> из{' '}
