        ...
        <tbody>
          {answers.map((answer, index) => (
            <tr key={answer.id} className="even:bg-gray-50">
              ...
              <td className="border-b border-gray-400 bg-gray-100 bg-white">
                <div
              ...
              <td>
                ...
                >
                  {answer.votesNumber ? answer.votesNumber.toFixed(2) : 0}
                </div>
              </td>
              <td>
                <div
                ...
                >
                  {potentialVotersNumber
                    ? Math.round(
                        (answer.votesNumber / potentialVotersNumber) *
                          100 *
                          100,
                      ) / 100
                    : 0}
          ...
          <tr className="border-b border-gray-400 bg-gray-100 bg-white">
            ...
            <td>
              <div className="whitespace-nowrap bg-gray-200 px-1 py-4 text-center text-sm font-bold">
                {votersNumber ? votersNumber.toFixed(2) : 0} из{' '}
                {potentialVotersNumber}
              </div>
            </td>
            <td>
              <div className="whitespace-nowrap bg-gray-200 px-1 py-4 text-center text-sm font-bold">
                {potentialVotersNumber > 0
                  ? Math.round(
                      (votersNumber / potentialVotersNumber) * 100 * 100,
                    ) / 100
                  : 0}
                %
              </div>
