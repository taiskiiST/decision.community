<button
    ...
    wire:click="onEmailItemIconButtonClicked({{ $item->id }})"
>
    <span class="hover:text-blue-500">
        <svg class="w-4 h-4 ml-1" enable-background="new 0 0 32 32" stroke="currentColor" id="Layer_1" version="1.1" viewBox="0 0 32 32" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
