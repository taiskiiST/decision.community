...
const ChildrenAndParentsInformation = () => {
  ...
  const validateParent = () => {
    if (
      ...
      document.getElementById('parent_name').value.length > 0 &&
      document.getElementById('parent_relationship') &&
      document.getElementById('parent_relationship').value.length > 0 &&
      document.getElementById('parent_address') &&
      document.getElementById('parent_address').value.length > 0 &&
      document.getElementById('parent_phone') &&
      document.getElementById('parent_phone').value.length > 0
    ) {
