  ...
  const validateChildren = (children) => {
    const mapValidChildren = children.map((child, index) => {
      if (
        child.name &&
        child.name.length > 0 &&
        child.date_of_birthday &&
        child.date_of_birthday.length > 0
      ) {
  ...
  return (
    <div className="container px-4">
      ...
      >
        ...
        <div className="col-span-6 mt-2 border-t-8 border-double border-gray-400 sm:col-span-3">
          <h1 className="mt-3 text-center text-lg font-bold leading-6 text-gray-900">
          ...
          <div className="inline-flex w-full flex-row">
            ...
            >
              Введите полное ФИО родителя или родственника или лица их
              замещающего
            </label>
          </div>
          <input
          ...
          <div className="inline-flex w-full flex-row">
            <label
              ...
              className="mt-3 block text-sm font-medium text-gray-700"
            >
              Укажите спень родства (папа, мама, бабушка, брат, сестра и т.п.)
            </label>
          </div>
          <input
            type="text"
          ...
          <div className="inline-flex w-full flex-row">
            <label
              ...
              className="mt-3 block text-sm font-medium text-gray-700"
            >
              Укажите улицу проживания на поселке и номер дома
            </label>
          </div>
          <input
            type="text"
          ...
          <div className="inline-flex w-full flex-row">
            <label
              ...
              className="mt-3 block text-sm font-medium text-gray-700"
            >
              Укажите контактный номер телефона родителя или родственника или
              лица их замещающего в формате <b>89XXXXXXXXX</b>
            </label>
        ...
        <div className="col-span-6 mt-5 border-t-8 border-dotted border-gray-400 sm:col-span-3">
          <h1 className="mt-3 text-center text-lg font-bold leading-6 text-gray-900">
            ...
            >
              ...
              <div className="inline-flex w-full flex-row">
                <label
                  ...
                  className="mt-3 block text-sm font-medium text-gray-700"
                >
                  Введите название или номер школы (садика)
                </label>
              </div>
              <DebounceInput
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              ...
              <div className="inline-flex w-full flex-row">
                <label
                  htmlFor={`school-address-${index}`}
                  className="mt-3 block text-sm font-medium text-gray-700"
                >
                  Введите адрес школы (садика)
                </label>
              </div>
              <DebounceInput
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              ...
              <div className="inline-flex w-full flex-row">
                <label
                  htmlFor={`school-time-to-${index}`}
                  className="mt-3 block text-sm font-medium text-gray-700"
                >
                  Введите по какому графику и ко скольки по времени вы возете
                  ребенка в школу (садик)
                </label>
              </div>
              <DebounceInput
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
              ...
              <div className="inline-flex w-full flex-row">
                <label
                  htmlFor={`school-time-from-${index}`}
                  className="mt-3 block text-sm font-medium text-gray-700"
                >
                  Введите по какому графику и в какое временя вы забираете
                  ребенка из школы (садика)
                </label>
              </div>
              <DebounceInput
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
        ...
        <div className="inline-flex w-full flex-row place-content-center">
          <div className="bg-gray-50 px-4 py-3  sm:px-6">
            <button
              type="submit"
              className="justify-center rounded-md border border-transparent bg-green-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
            >
              Отправить данные
            </button>
          </div>
