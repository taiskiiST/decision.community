    ...
    <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        <div class="sm:flex sm:items-start">
            ...
            <div class="mt-3 sm:mt-0 sm:ml-4 text-center sm:text-left w-full">
                ...
                <div class="mt-2">
                    <label for="youtube_video_url" class="block text-sm font-medium text-gray-700">
                        URL
                    </label>
                    ...
                    <div class="mt-1 flex rounded-md shadow-sm">
                        ...
                        <input
                            ...
                            type="text" name="youtube_video_url"
                            id="youtube_video_url"
                            class="focus:ring-indigo-500 focus:border-indigo-500 flex-1 block w-full rounded-none rounded-r-md sm:text-sm border-gray-300"
                            placeholder="www.youtube.com/watch?v=haKKtOHs-XM"
                        >
                    </div>
                ...
                <div class="mt-2 p-2">
                    <div class="flex items-start">
                        ...
                        <div class="ml-3 text-sm text-left">
                            ...
                            <p class="text-gray-500">If checked, this video will be available only to employees.</p>
                        </div>
                    </div>
                </div>

                <div
                    wire:loading.delay wire:target="submitForm"
