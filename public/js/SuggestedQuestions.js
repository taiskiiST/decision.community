...
function SuggestedQuestions() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_0__.useEffect)(function () {
    var results = suggested_questions.filter(function (question) {
      ...
      return question.text.toLowerCase().includes(searchTermLowerCased) || itemsNameHash[question.author].toLowerCase().includes(searchTermLowerCased) || itemsPollNameHash[question.poll_id].toLowerCase().includes(searchTermLowerCased);
    });
